  ...
  return (
    <main>
      ...
      <div className='container p7'>
        ...
        <AutoCompliteTegs placholder='' type='text' label='Ключевые навыки' size='fieldset-md' items={allSkills} onSelect={onSkillsChange} selected={skills.split(",").map(item => ({name: item}))}/>
